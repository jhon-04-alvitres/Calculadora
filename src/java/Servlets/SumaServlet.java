...
public class SumaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer numero1 = Integer.parseInt(request.getParameter("numero1"));/*primer parametro del formuario**/
        ...
        /**
         * enviar denuevo a un formulario *
         */
        request.setAttribute("resp", suma);
